...
@llvm.used = appending global [3 x i8*] [i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (i32 (%struct.xdp_md*)* @xdp_drop_func to i8*), i8* bitcast (i32 (%struct.xdp_md*)* @xdp_pass_func to i8*)], section "llvm.metadata"

; Function Attrs: norecurse nounwind readnone
define dso_local i32 @xdp_pass_func(%struct.xdp_md* nocapture readnone %0) #0 section "xdp_pass" !dbg !23 {
  call void @llvm.dbg.value(metadata %struct.xdp_md* undef, metadata !38, metadata !DIExpression()), !dbg !39
  ret i32 2, !dbg !40
}

; Function Attrs: norecurse nounwind readnone
define dso_local i32 @xdp_drop_func(%struct.xdp_md* nocapture readnone %0) #0 section "xdp_drop" !dbg !41 {
...
!1 = distinct !DIGlobalVariable(name: "_license", scope: !2, file: !3, line: 31, type: !15, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "xdp_prog_kern.c", directory: "/home/saif/Desktop/xdp-tutorial/basic02-prog-by-name")
!4 = !{!5}
!5 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "xdp_action", file: !6, line: 2845, baseType: !7, size: 32, elements: !8)
!6 = !DIFile(filename: "../headers/linux/bpf.h", directory: "/home/saif/Desktop/xdp-tutorial/basic02-prog-by-name")
