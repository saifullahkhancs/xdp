...
@llvm.used = appending global [2 x i8*] [i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (i32 (%struct.xdp_md*)* @xdp_drop_func to i8*)], section "llvm.metadata"

; Function Attrs: norecurse nounwind readnone
define dso_local i32 @xdp_drop_func(%struct.xdp_md* nocapture readnone %0) #0 section "xdp_abort" !dbg !23 {
...
!3 = !DIFile(filename: "xdp_prog_kern.c", directory: "/home/saif/Desktop/xdp-tutorial/tracing01-xdp-simple")
!4 = !{!5}
...
!23 = distinct !DISubprogram(name: "xdp_drop_func", scope: !3, file: !3, line: 6, type: !24, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !37)
